...
public final class PageRank {
    ...
    public static JavaPairRDD<Integer, Double> sparkPageRank(
        ...
        JavaPairRDD<Integer, Double> updatedRanks = sites
                .join(ranks)
                .flatMapToPair(PageRank::flatMap);

        return updatedRanks.reduceByKey(Double::sum).mapValues(v -> 0.15 + 0.85 * v);
    }
