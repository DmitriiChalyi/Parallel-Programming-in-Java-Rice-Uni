...
public final class ParBoruvka extends AbstractBoruvka<ParBoruvka.ParComponent> {
    ...
    public void computeBoruvka(final Queue<ParComponent> nodesLoaded,
        ...
        while ((curr = nodesLoaded.poll()) != null) {
            ...
            final Edge<ParComponent> minEdge = curr.getMinEdge();
            if (minEdge == null) {
                curr.lock.unlock();
                solution.setSolution(curr);
            }

            final ParComponent other = minEdge.getOther(curr);
            ...
            other.isDead = true;
            curr.merge (other, minEdge.weight());
